...
public class DemoLoginPage extends PageObject {
    ...
    public static final Target UNSUCCESSFUL_SIGN_IN_MESSAGE = Target.the("Unsuccessful sign in message").located(By.cssSelector("body > div.master-wrapper-page > div > div > div > div > div.page-body > div.customer-blocks > div > form > div.message-error.validation-summary-errors"));
}
